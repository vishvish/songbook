%% `help.tex'---Balham Ukulele Society Songbook. 
%% The help manual for Balham Ukulele Society's songbook.
%% Useful for those who want to contribute.
%% 
...
% Balham Ukulele Society Songbook Help Manual
% Master A4 version
...
% Great fonts to use if working on a Mac
% \setromanfont [Scale=0.9, Ligatures={Common}, Numbers={OldStyle}]{Minion Pro}
...
% ---- CUSTOM AMPERSAND
\newcommand{\amper}{{\fontspec[Scale=.95]{Myriad Pro}\selectfont\itshape\&}}
...
\hfill \chord{t}{3,5,2,1}{F\large{m}}
